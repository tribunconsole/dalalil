	...
	*/
	...
	var controls = {
	  ...
	  bindMenuItemShortcuts: function bindMenuItemShortcuts(menuItem, type) {
	    ...
	    on.call(this, menuItem, 'keydown keyup', function (event) {
	      // We only care about space and â¬†ï¸ â¬‡ï¸ï¸ âž¡ï¸
	...
	var defaults$2 = {
	  ...
	  'progress', 'current-time', // 'duration',
       'captions', 'settings', 'pip', 'airplay', //'mute', 'volume','download',
	  'fullscreen'],
	...
	var ui = {
	  ...
	  migrateStyles: function migrateStyles() {
	    ...
	    // Loop through values (as they are the keys when the object is spread ðŸ¤”)
	        ...
	        if (is$2.element(focused)) {
	          ...
	          if (event.which === 32 && matches$2(focused, 'button, [role^="menuitem"]')) {
	            return;
                  ...
                  var preventDefault = [32, 37, 39, 48, 49, 50, 51, 52, 53, 54, 56, 57, 67, 70, 73, 75, 76, 77, 79]; // If the code is found prevent default (e.g. prevent scrolling for arrows)
